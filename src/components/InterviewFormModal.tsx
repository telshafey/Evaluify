    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4" onClick={onClose}>
            <div role="dialog" aria-modal="true" aria-labelledby="interview-modal-title" className="modal-content-container bg-white dark:bg-slate-800 rounded-lg shadow-2xl p-8 w-full max-w-md" onClick={e => e.stopPropagation()}>
                <h2 id="interview-modal-title" className="text-2xl font-bold mb-6 text-slate-800 dark:text-slate-100">{t.title}</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="candidateName" className="block text-sm font-medium text-slate-700 dark:text-slate-300">{t.candidateName}</label>
                    ...
                    <div>
                        <label htmlFor="date" className="block text-sm font-medium text-slate-700 dark:text-slate-300">{t.date}</label>
                    ...
                    <div>
                        <label htmlFor="interviewerName" className="block text-sm font-medium text-slate-700 dark:text-slate-300">{t.interviewer}</label>
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        <button type="submit" className="bg-primary-500 hover:bg-primary-600 text-white font-bold py-2 px-4 rounded-lg">{t.save}</button>
                    </div>
                </form>
            </div>
        </div>
