...
const translations = {
    ...
    ar: {
        ...
        generationDesc: "استفد من قوة Gemini لمكافحة الغش وإنشاء تقييمات مخصصة في ثوانٍ. يمكن للذكاء الاصطناعي لدينا إنشاء أسئلة فريدة، أو اختبارات كاملة، أو نماذج متنوعة من الأسئلة الحالية، مما يضمن حصول كل مرشح على اختبار مختلف ولكنه مكافئ في الصعوبة.",
        ...
        analyticsDesc: "تجاوز الدرجات البسيطة. توفر لوحة التحكم التحليلية لدينا رؤى عميقة حول أداء المرشحين وفعالية الأسئلة والاتجاهات العامة. حدد فجوات المعرفة واتخذ قرارات مبنية على البيانات لتحسين مخرجات التعلم.",
