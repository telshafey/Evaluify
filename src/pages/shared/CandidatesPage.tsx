...
import { Candidate, CandidateStatus, CvAnalysisResult } from '../../types.ts';
import KanbanBoard from '../../components/kanban/KanbanBoard.tsx';
import { PlusCircleIcon, FunnelIcon } from '../../components/icons.tsx';
import { getCandidates, addCandidate, updateCandidateStatus } from '../../services/mockApi.ts';
import { useNotification } from '../../contexts/NotificationContext.tsx';
import { useLanguage } from '../../App.tsx';
import KanbanSkeleton from '../../components/skeletons/KanbanSkeleton.tsx';
import CandidateFormModal from '../../components/candidates/CandidateFormModal.tsx';
import CvAnalyzerModal from '../../components/CvAnalyzerModal.tsx';
...
const CandidatesPage: React.FC<CandidatesPageProps> = ({ pageTitle }) => {
    ...
    const handleAddCandidate = async (candidateData: Omit<Candidate, 'id' | 'stage' | 'lastActivity'>) => {
        try {
